...
function renderMovies() {
    ...
    if (!searchValue) {
        root.innerHTML = '<p class="search-no">Unable to find what you’re looking for. Please try another search.</p>';
        return;
    }
    ...
    fetch(`https://www.omdbapi.com/?apikey=1b9d87f6&type=movie&s=${inputEl.value}`)
        ...
        .then(moviesData => {
            ...
            movies = moviesData;
            movies.forEach(data => {
                const isMovieInWatchlist = watchlist.some(movie => movie.imdbID === data.imdbID);
                root.innerHTML += `
                    <div class="movie">
                        ...
                        <div class="des-container">
                            ...
                            <div class="middle">
                                ...
                                <div class="watchlist-con">
                                    ...
                                    <button class="watchlist-btn" data-imdbid="${data.imdbID}"><img src="images/plus.png"/></button>
...
function addToWatchlist(e) {
    ...
    if (!isMovieInWatchlist) {
        ...
        if (movieToAdd) {
            ...
            const addedElement = e.currentTarget.parentElement.querySelector('.added');
            if (addedElement) {
            ...
            const watchlistText = e.currentTarget.parentElement.querySelector('.watchlist-text');
            if (watchlistText) {
